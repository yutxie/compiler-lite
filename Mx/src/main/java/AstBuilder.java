...
public class AstBuilder {
    ...
    private class ParseTreeVisitor extends MxParserBaseVisitor<AstNode> {

        @Override
        public AstNode visitProgram(MxParser.ProgramContext context) {
        ...
        @Override
        public AstNode visitClassDefinition(MxParser.ClassDefinitionContext context) {
            ClassDefinitionNode res = new ClassDefinitionNode();
            res.identifier = (IdentifierExpressionNode)visit(context.Identifier());
        ...
        @Override
        public AstNode visitMemberVariable(MxParser.MemberVariableContext context) {
            DefinitionExpressionNode res = new DefinitionExpressionNode();
            res.variableType = new VariableType(context.variableType().getText());
            res.variableIdentifier = (IdentifierExpressionNode)visit(context.Identifier());
            res.initValue = null;
            return res;
        }

        @Override
        public AstNode visitConstructionMethodDefinition(MxParser.ConstructionMethodDefinitionContext context) {
        ...
        @Override
        public AstNode visitMethodDefinition(MxParser.MethodDefinitionContext context) {
        ...
        @Override
        public AstNode visitFormalParameter(MxParser.FormalParameterContext context) {
            DefinitionExpressionNode res = new DefinitionExpressionNode();
            res.variableType = new VariableType(context.variableType().getText());
            res.variableIdentifier = (IdentifierExpressionNode)visit(context.Identifier());
            res.initValue = null;
        ...
        @Override
        public AstNode visitBlock(MxParser.BlockContext context) {
        ...
        @Override
        public AstNode visitBlockOrStatement(MxParser.BlockOrStatementContext context) {
        ...
        @Override
        public AstNode visitDefinitionStat(MxParser.DefinitionStatContext context) {
            return (DefinitionExpressionNode)visit(context.definitionStatement().definitionExpression());
        }

        @Override
        public AstNode visitExpressionStat(MxParser.ExpressionStatContext context) {
            return (ExpressionStatementNode)visit(context.expression());
        }

        @Override
        public AstNode visitIfStat(MxParser.IfStatContext context) {
        ...
        @Override
        public AstNode visitForStat(MxParser.ForStatContext context) {
        ...
        @Override
        public AstNode visitWhileStat(MxParser.WhileStatContext context) {
        ...
        @Override
        public AstNode visitReturnStat(MxParser.ReturnStatContext context) {
        ...
        @Override 
        public AstNode visitBreakStat(MxParser.BreakStatContext context) {
            return new BreakStatementNode();
        }

        @Override
        public AstNode visitContinueStat(MxParser.ContinueStatContext context) {
            return new ContinueStatementNode();
        }

        @Override
        public AstNode visitEmptyStat(MxParser.EmptyStatContext context) {
            return new EmptyStatementNode();
        }

        @Override
        public AstNode visitDefinitionStatement(MxParser.DefinitionStatementContext context) {
        ...
        public AstNode visitIdentifierExpr(MxParser.IdentifierExprContext context) {
            IdentifierExpressionNode res = new IdentifierExpressionNode();
            res.identifierStr = context.getText();
            return res;
        }

        @Override
        public AstNode visitConstantExpr(MxParser.ConstantExprContext context) {
            ConstantExpressionNode res = new ConstantExpressionNode();
            res.constantStr = context.getText();
            switch(context.Constant().getSymbol().getType()) {
        ...
        @Override
        public AstNode visitThisExpr(MxParser.ThisExprContext context) {
            return new ThisExpressionNode();
        }

        @Override
        public AstNode visitMemberAccessExpr(MxParser.MemberAccessExprContext context) {
        ...
        @Override
        public AstNode visitIndexAccessExpr(MxParser.IndexAccessExprContext context) {
        ...
        @Override
        public AstNode visitMethodCallExpr(MxParser.MethodCallExprContext context) {
        ...
        @Override
        public AstNode visitParensExpr(MxParser.ParensExprContext context) {
            return (ExpressionStatementNode)visit(context.expression());
        }

        @Override
        public AstNode visitNewExpr(MxParser.NewExprContext context) {
        ...
        @Override
        public AstNode visitUnaryExpr(MxParser.UnaryExprContext context) {
        ...
        @Override
        public AstNode visitBinaryExpr(MxParser.BinaryExprContext context) {
        ...
        @Override
        public AstNode visitDefinitionExpr(MxParser.DefinitionExprContext context) {
            return (DefinitionExpressionNode)visit(context.definitionExpression());
        }

        @Override
        public AstNode visitDefinitionExpression(MxParser.DefinitionExpressionContext context) {
            DefinitionExpressionNode res = new DefinitionExpressionNode();
            res.variableType = new VariableType(context.variableType().getText());
            res.variableIdentifier = (IdentifierExpressionNode)visit(context.Identifier());
    ...
    public static AstNode buildAst(String path) {
    ...
    public static void printInformation(AstNode ast) {
        ast.printInformation();
    }

    // ----------------------- main --------------------------------------
    public static void main(String args[]) {

        AstNode ast = buildAst("example/0.txt");
